...
urlpatterns = [
    ...
    path("campaign-links/<str:token>", views.CampaignLinkResolve.as_view()),
    ...
    path("orders/<int:pk>/preview", views.PreviewOrder.as_view()),
    path("orders/<int:pk>/cancel", views.CancelOrder.as_view()),
    path("orders/<int:pk>/refund", views.RefundOrder.as_view()),
